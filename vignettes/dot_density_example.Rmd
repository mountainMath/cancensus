...
```{r}
sp <- cancensus.load(geo_format='sp',dataset='CA16', regions='{"CMA":["59933"]}', vectors=c("v_CA16_2066","v_CA16_2060","v_CA16_1916","v_CA16_1727","v_CA16_1937","v_CA16_1958","v_CA16_1973"), level='DA')
```
...
base_geom <- cancensus.load(geo_format ='sp', dataset='CA16', regions='{"CMA":["59933"]}',  level='CSD')
```
