...
library(cancensus)
# cancensus.set_api_key('your_key')
```
...
```{r, message=FALSE}
census_data <- cancensus.load(dataset='CA11', regions='{"CSD":["5915022","5915025","5915015","5915011","5915004","5915029","5915046","5915055","5915034"]}', vectors=c("v_CA11N_2221","v_CA11N_2224","v_CA11N_2227","v_CA11N_2218"), level='CSD')
```
...
```{r, message=FALSE}
# Requires latest version of ggplot2 to effortless plot sf objects and viridis for colour scales.
...
ggplot(commutes) +
  ...
  scale_fill_viridis("Share of commuters") +
