...
# grab 6 largest CMAs
cma_list <- list_census_regions(dataset) %>% 
  filter(level=='CMA') %>% 
  top_n(6, pop) %>%
  pull(region)
...
categories <- census_labels(census_data)
