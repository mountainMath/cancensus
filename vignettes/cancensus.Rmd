...
find_census_vectors("Australian ethnic", dataset = "CA16", type = "total", query_type = "keyword")
```

```{r}
find_census_vectors("Australian", dataset = "CA16", type = "total", query_type = "exact")
```
