...
## ------------------------------------------------------------------------
plot(st_geometry(toronto), col = NA, main = "Toronto CSDs with Median HH Income > $100,000", lty = 3)
plot(st_geometry(toronto[toronto$median_hh_income > 100000,]), col = "red", add = TRUE)
